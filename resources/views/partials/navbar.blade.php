            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle ms-4" href="#" id="navbarDropdownMenuLink" role="button"
                ...
                @else
                    <a href="/login" class="btn btn-outline-primary btn-dark ms-4"><i class="bi bi-box-arrow-in-right"></i>
                        Login</a>
                @endauth
                </li>
            </ul>
